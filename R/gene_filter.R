#' Removes low expression and low variability genes from a gene expression matrix.
#' Filters by the proportion of expressed genes, and/or min expression difference.
#'
#' A wrapper of two genefilter functions to filter low expressed and low variability genes (rows).
